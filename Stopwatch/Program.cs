...
Console.WriteLine("To start the stopwatch, enter 's' below.");
...
{
    Console.WriteLine($"You entered an invalid input.  Please try again and insert the letter 's'.");
}

Console.WriteLine("To stop the stopwatch, enter 'f' below.");

var stop = Console.ReadLine()!.ToUpper();
...
{
    Console.WriteLine($"You entered an invalid input.  Please try again and insert the letter 'f'.");
}